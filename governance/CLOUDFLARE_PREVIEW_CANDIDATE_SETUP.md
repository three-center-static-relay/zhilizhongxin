...
- deploy/version command contains `wrangler versions upload`.
...
- [ ] All four Workers have a preview trigger that excludes `main` and uses `npx wrangler versions upload`.
