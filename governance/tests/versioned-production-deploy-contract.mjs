...
console.log(JSON.stringify({ok:true,suite:"versioned-production-deploy-contract",fail_closed:true,rollback:true,lifecycle_change_blocked:true,shallow_history_recovery:true}));
