...
assert.equal(samples.every(Boolean),true,'TENCENT_8F8_STABLE_FAIL_REQUIRED');
console.log(JSON.stringify({ok:true,suite:'tencent-8f8-stable-fail',failed_commit:expected,samples:samples.length,stable_window_ms:17500,production_routing:false,agent_execution_enabled:false,deploy_probe_active:false,secret_values_exposed:false}));
