...
console.log(JSON.stringify({ok:true,suite:"governance-model-source-policy",approved_sources:["workers-ai","openrouter","huggingface"],workers_ai_free_only:true,direct_vendor_sources:false,phase2_covered:true,scanned_runtime_files:files.length}));
