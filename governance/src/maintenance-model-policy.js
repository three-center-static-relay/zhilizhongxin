...
export const MAINTENANCE_MODEL_POLICY=Object.freeze({
  strategy:"cloudflare-free-stable-pool-with-dynamic-health-routing",
  ...
  fixed_deepseek:false,
  paid_budget_default_usd:0,
  automatic_paid_fallback:false,
  codex_role:"code-repair-only-after-code-defect-classification",
...
export function leaderboardCandidatePolicy(candidate={}){
  return {
    eligible:Boolean(clean(candidate.model))&&candidate.health_pass===true&&candidate.contract_pass===true&&candidate.free_or_budget_ok===true,
