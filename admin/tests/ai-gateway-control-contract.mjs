...
console.log(JSON.stringify({ok:true,suite:"ai-gateway-control-broker",named_entrypoint_only:true,operation_whitelist:true,read_delegated_to_credential_custodian:true,credential_custodian:"maintenance-worker",control_plane_owner:"admin-worker",no_delete:true,no_token_return:true,jsonc_comments_supported:true}));
