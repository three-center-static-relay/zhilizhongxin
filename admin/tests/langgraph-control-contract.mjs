...
assert.match(test,/Prioritize price-performance/);
assert.match(test,/Control response length softly/);
assert.match(test,/Tools are forbidden/);
assert.match(test,/token_cap:false/);
assert.match(test,/cost_control:"soft-price-performance"/);
assert.match(test,/length_control:"soft-adaptive"/);
assert.doesNotMatch(test,/max_paid_usd/);
assert.doesNotMatch(test,/max_tokens/);
