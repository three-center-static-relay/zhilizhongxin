...
assert.match(control,/https:\/\/intelligence\.internal\/v1\/selftest\/providers/);
assert.match(control,/https:\/\/compute\.internal\/v1\/admin\/modelscope\/studio-lite\/compute/);
assert.match(control,/https:\/\/expert\.internal\/v1\/selftest/);
assert.match(control,/runFourCenterExecutionCanary/);
assert.match(control,/langgraph-four-center-execution-v2/);
assert.match(control,/center_execution_receipts/);
assert.match(control,/all_centers_planned/);
assert.match(control,/all_centers_executed/);
assert.match(control,/model-advisory-governance-validated-real-four-center-service-binding-dispatch/);
...
assert.match(control,/paid_execution:false/);
...
assert.match(test,/safeBrainReceipt/);
assert.match(test,/brain_source/);
assert.match(test,/brain_provider/);
assert.match(test,/brain_model/);
assert.match(test,/brain_fallback_used/);
assert.match(test,/brain_degraded/);
assert.match(test,/brain_advisory_applied/);
