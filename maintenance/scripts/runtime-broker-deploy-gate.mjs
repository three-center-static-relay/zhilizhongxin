...
function main(){
  ...
  emit({ok:true,event:"MAINTENANCE_RUNTIME_DEPLOY_GATE_START",commit_sha:sha,control_plane_owner:"admin-worker",cloudflare_credentials_local:false,dynamic_route_mutation:false});
