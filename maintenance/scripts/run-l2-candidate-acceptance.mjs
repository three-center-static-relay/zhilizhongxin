...
function main(){
  console.log(JSON.stringify({event:"L2_ADMIN_CANDIDATE_RESOLUTION_SNAPSHOT_PROBE_MODE",admin_candidate_upload_owner:"admin-build",maintenance_mutation:false,admin_deployment_mutation:false,cross_worker_versions_list:true,cross_worker_deployment_status:true,remote_dev:false,build_secret_value_read:false,ai_gateway_called:false,dynamic_routes_mutated:false,secrets_redacted:true}));
  ...
  if(result.error||result.status!==0)throw new Error("L2_ADMIN_READ_PROBE_FAILED");
}
