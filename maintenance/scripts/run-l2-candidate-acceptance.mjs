...
function main(){
  console.log(JSON.stringify({event:"L2_ADMIN_ZERO_STAGE_RESTORE_PROBE_MODE",admin_candidate_upload_owner:"admin-build",admin_stage_zero:true,admin_restore_required:true,maintenance_deployment_mutation:false,maintenance_version_upload:false,remote_dev:false,build_secret_value_read:false,ai_gateway_called:false,dynamic_routes_mutated:false,secrets_redacted:true}));
  ...
  if(result.error||result.status!==0)throw new Error("L2_ADMIN_ZERO_STAGE_PROBE_FAILED");
}
